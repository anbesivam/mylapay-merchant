...
export default function ShopDetails({ shopID, stepChange }) {
  ...
  const onTogglethemetemeplate = async (event, itemplate, templateurl) => {
    ...
    // console.log("itemplate id  : " + event);
  ...
  const onToggle = async (event) => {
    ...
    if (event.target.checked) {
      ...
      // console.log("Selected image : " + imageArray.length + " " + galleryimages.length);
  ...
  const handlePreviewClick = () => {
    ...
    if (optionSelected != null) {
      ...
      formik.values.pinterest =
        "https://in.pinterest.com/" + formik.values.pinterest;
  ...
  const handleselectedthemegallery = async () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        // console.log(
        //   "Selected Gallery images : " + JSON.stringify(themegalleryimages)
        // );
        if (countarr <= 5) {
  ...
  const handleselectedgallery = async () => {
    ...
    // console.log("Selected Gallery images : " + JSON.stringify(countarr));
          ...
          if (res.data.status === 1) {
            ...
            if (shopDetails) {
              if (values.pinterest != null && values.pinterest != "") {
                formik.setFieldValue(
                  "pinterest",
                  values.pinterest.split("https://in.pinterest.com/").pop()
                );
              }
  ...
  useEffect(() => {
    if (shopDetails) {
      ...
      if (shopDetails.pinterest != null && shopDetails.pinterest != "") {
        formik.setFieldValue(
          "pinterest",
          shopDetails.pinterest.split("https://in.pinterest.com/").pop()
        );
      }
                  ...
                  if (res.data.status === 1) {
                    ...
                    res.data.message.map((tem_value, tem_index) => {
                      if (
                        ...
                        //     if (res.data.status === 1) {
                        //       // setselectedthemelist(res.data.message)
                        //       // console.log("Mylapay gallery : " + res.data.message[0].banners)
                        //       // setmylapaygallerybanner(res.data.message[0].banners);
                        //     }
                        //   });
                      }
