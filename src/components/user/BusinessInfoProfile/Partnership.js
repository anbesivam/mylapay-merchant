...
import { yupSchema, emptyInitVals } from "./partnershipData";
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < prefillData.length; i++) {
      ...
      switch (el.proofType) {
        ...
        case "Company Proof":
          if(el.proofName === "Partnership Firm PAN"){
          ...
          else if(el.proofName === "Partnership deed"){
          ...
          else if(el.proofName === "List of Partners"){
    ...
    <form onSubmit={formik.handleSubmit}>
      ...
      <Box pb={1}>
        <Typography variant="h6">
          Merchant Personal Id proof (partner 1)
        </Typography>
      </Box>
      ...
      <Box py={1}>
        <Typography variant="h6">
          Merchant Personal Id proof (partner 2)
        </Typography>
      </Box>
      <Box p={2} className="card">
        <Grid container spacing={2}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={3}>
            <TextField
              ...
              variant="outlined"
              fullWidth
              id="identification_number_4"
              name="identification_number_4"
              value={formik.values.identification_number_4}
              disabled="true"
              onChange={formik.handleChange}
              onBlur={(e) => {
                formik.setFieldTouched("identification_number_4");
                formik.handleChange(e);
              }}
              error={
                formik.touched.identification_number_4 &&
                Boolean(formik.errors.identification_number_4)
              }
              helperText={
                formik.touched.identification_number_4 &&
                formik.errors.identification_number_4
              }
            />
          </Grid>
          <Grid item xs={12} md={3}>
