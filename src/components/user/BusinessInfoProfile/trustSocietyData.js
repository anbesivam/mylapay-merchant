...
const yupSchema = yup.object({
  ...
  file_full_path_0: yup.mixed().nullable().required("Required Field"),
  ...
  file_full_path_1: yup.mixed().nullable().required("Required Field"),
