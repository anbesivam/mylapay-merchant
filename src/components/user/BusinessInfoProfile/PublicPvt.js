...
export default function PublicPvt() {
  ...
  const SERVER_IMAGE_URL = "https://api.mylapay.com/uploads/";
    ...
    for (let i = 0; i < prefillData.length; i++) {
      ...
      switch (el.proofType) {
        ...
        case "Company Proof":
          if(el.proofName === "MOA"){
          ...
          else if(el.proofName === "Certificate of Incorporation"){
          ...
          else if(el.proofName === "Company PAN"){
           ...
           else if(el.proofName === "List of Directors"){
            formik.setFieldValue("proof_name_10", el.proofName);
            formik.setFieldValue(
              "identification_number_10",
              el.identificationNumber
            );
            formik.setFieldValue("name_10", el.nameAsPerDoc);
            if(el.filePath){
              formik.setFieldValue("file_10", {
                filePath: el.filePath,
                name: el.file_name,
              });
              formik.setFieldValue("file_full_path_10",el.filePath.replace(/\\/g, "/"));  
            }
            // formik.setFieldValue("file_10", {
            //   filePath: el.filePath,
            //   name: el.file_name,
            // });
            // formik.setFieldValue("file_full_path_10",el.filePath.replace(/\\/g, "/"));
            formik.setFieldValue("iBusinessInfo_10", el.iBusinessInfo);
            formik.setFieldValue("status_10", el.status);
        ...
        case "Bank Account Proof":
          formik.setFieldValue("proof_name_11", el.proofName);
          formik.setFieldValue(
            "identification_number_11",
            el.identificationNumber
          );
          formik.setFieldValue("name_11", el.nameAsPerDoc);
          formik.setFieldValue("file_11", {
            filePath: el.filePath,
            name: el.file_name,
          });
          formik.setFieldValue("file_full_path_11",el.filePath.replace(/\\/g, "/"));
          formik.setFieldValue("iBusinessInfo_11", el.iBusinessInfo);
          formik.setFieldValue("status_11", el.status);
    ...
    <form onSubmit={formik.handleSubmit}>
      ...
      <Box p={2} className="card">
        <Grid container spacing={2}>
          ...
          <Grid item md={1}>
            <a href={`${SERVER_IMAGE_URL}${formik.values["file_full_path_5"]}`} target="_blank" rel="noreferrer">
              <img className="view_docs" src={process.env.PUBLIC_URL + '/view_docs.png'} alt="Document View" />   
            </a>  
          </Grid>
          <Grid item xs={12} md={3}></Grid>
          ...
          <Grid item md={1}>
            <a href={`${SERVER_IMAGE_URL}${formik.values["file_full_path_6"]}`} target="_blank" rel="noreferrer">
              <img className="view_docs" src={process.env.PUBLIC_URL + '/view_docs.png'} alt="Document View" />   
            </a>  
          </Grid>
          <Grid item xs={12} md={3}></Grid>
          ...
          <Grid item md={1}>
            <a href={`${SERVER_IMAGE_URL}${formik.values["file_full_path_7"]}`} target="_blank" rel="noreferrer">
              <img className="view_docs" src={process.env.PUBLIC_URL + '/view_docs.png'} alt="Document View" />   
            </a>  
          </Grid>
          ...
          <Grid item md={1}>
            <a href={`${SERVER_IMAGE_URL}${formik.values["file_full_path_8"]}`} target="_blank" rel="noreferrer">
              <img className="view_docs" src={process.env.PUBLIC_URL + '/view_docs.png'} alt="Document View" />   
            </a>  
          </Grid>
          <Grid item xs={12} md={3}></Grid>
          ...
          {/* <Grid item xs={12} md={3}>
            <DocTextField
              formik={formik}
              itemName="identification_number_9"
              label="Id Number"
            />
          </Grid>
          <Grid item xs={12} md={3}>
          ...
          <Grid item md={1}>
            <a href={`${SERVER_IMAGE_URL}${formik.values["file_full_path_9"]}`} target="_blank" rel="noreferrer">
              <img className="view_docs" src={process.env.PUBLIC_URL + '/view_docs.png'} alt="Document View" />   
            </a>  
          </Grid>
          <Grid item xs={12} md={3}></Grid>
          ...
          {/* <Grid item xs={12} md={3}>
            <DocTextField
              formik={formik}
              itemName="identification_number_10"
              label="Id Number"
            />
          </Grid>
          <Grid item xs={12} md={3}>
          ...
          <Grid item md={1}>
            <a href={`${SERVER_IMAGE_URL}${formik.values["file_full_path_10"]}`} target="_blank" rel="noreferrer">
              <img className="view_docs" src={process.env.PUBLIC_URL + '/view_docs.png'} alt="Document View" />   
            </a>  
          </Grid>
          <Grid item xs={12} md={3}></Grid>
      ...
      <Box p={2} className="card">
        <Grid container spacing={2}>
          ...
          <Grid item md={1}>
            <a href={`${SERVER_IMAGE_URL}${formik.values["file_full_path_11"]}`} target="_blank" rel="noreferrer">
              <img className="view_docs" src={process.env.PUBLIC_URL + '/view_docs.png'} alt="Document View" />   
            </a>  
          </Grid>
        </Grid>
