...
export default function RejectedPublicPvt() {
  ...
  const getLabel = (index) => {
    if (rejectedDocs[index].proofParty) {
      return (
        ...
        ` (director ${rejectedDocs[index].proofParty})`
      );
    } else {
                      ...
                      <Grid item xs={12} md={11}>
                        <Grid container spacing={2}>
                          ...
                          {formik.values[`proof_name_${index}`] !==
                            ...
                            formik.values[`proof_name_${index}`] !== "MOA" &&
                            formik.values[`proof_name_${index}`] !== "AOA" &&
                            formik.values[`proof_name_${index}`] !==
                              "Certificate of Incorporation" &&
                            formik.values[`proof_name_${index}`] !==
                              "Board Resolution Stating Opting for IPG Services" &&
