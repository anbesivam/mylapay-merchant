...
const emptyInitVals = {
  ...
  proof_name_4: "Trust / Society Deed",
  identification_number_4: "",
  name_4: "",
  file_4: null,

  type_5: "Company Proof",
  proof_name_5: "Trust / Society PAN",
...
const yupSchema = yup.object({
  ...
  //   .test(
  //     "is-taken",
  //     "Trustee 2 PAN number is same as Trustee 1 PAN number",
  //     (value, testContext) => {
  //       if (value)
  //         return value !== testContext.from[0].value.identification_number_0;
  //     }
  //   )
  //   .test(
  //     "is-taken",
  ...
  //   .test(
  //     "is-taken",
  //     "Trustee 2 Aadhar number is same as Trustee 1 Aadhar number",
  //     (value, testContext) => {
  //       if (value)
  //         return value !== testContext.from[0].value.identification_number_1;
  //     }
  //   )
  //   .test(
  //     "is-taken",
  ...
  identification_number_5: yup
    ...
    .test(
      "is-taken",
      "Truste/Society PAN number should not be same as Trustee 1 or Trustee 2 PAN number",
      (value, testContext) => {
        if (value)
          return value !== testContext.from[0].value.identification_number_0;
      }
    ...
    .test(
      ...
      (value, testContext) => {
        if (value)
          return value !== testContext.from[0].value.identification_number_2;
      }
    )
    .matches(
      /^([a-zA-Z]){5}([0-9]){4}([a-zA-Z]){1}?$/,
  ...
  // identification_number_7: yup.mixed().required("Required Field"),
