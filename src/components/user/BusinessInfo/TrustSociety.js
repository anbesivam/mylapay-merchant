        ...
        .then((response) => {
          if (response.data.success === 1) {
            ...
            if (fillData.length === 0) {
              formik.setFieldValue("name_5", response.data.business_name);
            } else {
  ...
  useEffect(() => {
    ...
    const generateInitialValues = async () => {
      ...
      for (let i = 0; i < prefillData.length; i++) {
        ...
        temp[`name_${i}`] =
          el.proofName === "Trust / Society PAN" && el.nameAsPerDoc === ""
            ? curBusName
            : el.nameAsPerDoc;
        temp[`file_${i}`] = file;
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={3}>
            <TextField
              ...
              variant="outlined"
              fullWidth
              id="identification_number_5"
              name="identification_number_5"
              value={formik.values.identification_number_5}
              onChange={formik.handleChange}
              onBlur={(e) => {
                formik.setFieldTouched("identification_number_5");
                formik.handleChange(e);
              }}
              error={
                formik.touched.identification_number_5 &&
                Boolean(formik.errors.identification_number_5)
              }
              helperText={
                formik.touched.identification_number_5 &&
                formik.errors.identification_number_5
              }
            />
          </Grid>
          <Grid item xs={12} md={3}>
