...
const yupSchema = yup.object({
  ...
  identification_number_2: yup
    ...
    .test(
      "is-taken",
      "Partner 2 PAN number is same as Partner 1 PAN number",(value, testContext) =>{
  ...
  identification_number_3: yup
    ...
    .test(
      "is-taken",
      "Partner 2 Aadhar number is same as Partner 1 Aadhar number",(value, testContext) =>{
  ...
  identification_number_4: yup
    ...
    .test(
      "is-taken",
      "Firm PAN number should not be same as Partner 1 or Partner 2 PAN number",(value, testContext) =>{
        if(value) return value !== testContext.from[0].value.identification_number_0; 
      }
    )
    .test(
  ...
  identification_number_5: yup
    .string()
    .required("Required Field")
    .test("len", "Enter valid 15 digit GST Number", (val) => {
      if (val) return val.toString().length === 15;
    })
